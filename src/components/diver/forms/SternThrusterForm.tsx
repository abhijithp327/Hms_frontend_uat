...
interface Props {
    ...
    onChange: (data: FormData["sternThruster"]) => void;
    onValidationChange?: (isValid: boolean, errors: Record<string, string>) => void;
}

const SternThrusterForm: React.FC<Props> = ({ data, onChange, onValidationChange }) => {
    ...
    const validateForm = (formData: FormData['sternThruster']) => {
        const result = sternThrusterSchema.safeParse(formData);
    ...
    const handleChange = (field: keyof FormData['sternThruster'], value: string | number | string[]) => {
...
export default SternThrusterForm;