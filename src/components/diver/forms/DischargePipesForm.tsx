...
interface Props {
    ...
    onChange: (data: FormData["dischargePipes"]) => void;
    onValidationChange?: (isValid: boolean, errors: Record<string, string>) => void;
}

const DischargesPipesForm: React.FC<Props> = ({ data, onChange, onValidationChange }) => {
    ...
    const handleChange = (field: keyof FormData['dischargePipes'], value: string | number | string[]) => {
...
export default DischargesPipesForm;