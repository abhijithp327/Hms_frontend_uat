...
interface Props {
    ...
    onChange: (data: FormData["propeller"]) => void;
    onValidationChange?: (isValid: boolean, errors: Record<string, string>) => void;
}

const PropellerForm: React.FC<Props> = ({ data, onChange, onValidationChange }) => {
    ...
    const validateForm = (formData: FormData['propeller']) => {
        const result = propellerSchema.safeParse(formData);
    ...
    const handleChange = (field: keyof FormData['propeller'], value: string | number | string[]) => {
    ...
    return (
        <div className="space-y-6 pb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <Label htmlFor="numberOfPropellersAssembly">Number Of Propeller Assembly</Label>
                    <Input
                        id="numberOfPropellersAssembly"
                        type="number"
                        value={data.numberOfPropellersAssembly || ""}
                        onChange={(e) => handleChange('numberOfPropellersAssembly', e.target.value)}
                        placeholder="Enter number of propellers assembly"
                        className="mt-1"
                    />
                </div>
