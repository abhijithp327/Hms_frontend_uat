...
interface Props {
    ...
    onChange: (data: FormData["sensors"]) => void;
    onValidationChange?: (isValid: boolean, errors: Record<string, string>) => void;
}

const SensorsForm: React.FC<Props> = ({ data, onChange, onValidationChange }) => {
    ...
    const handleChange = (field: keyof FormData['sensors'], value: string | number | string[]) => {
    ...
    return (
        <div className="space-y-6 pb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <Label htmlFor="mechanicalDamage">Mechanical Condition</Label>
