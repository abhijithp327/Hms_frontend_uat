...
interface Props {
    ...
    onChange: (data: FormData["kortNozzle"]) => void;
    onValidationChange?: (isValid: boolean, errors: Record<string, string>) => void;
}

const KortNozzleForm: React.FC<Props> = ({ data, onChange, onValidationChange }) => {
    ...
    const handleChange = (field: keyof FormData['kortNozzle'], value: string | number | string[]) => {
