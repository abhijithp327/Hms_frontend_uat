...
interface Props {
    ...
    onChange: (data: FormData["aboveWaterlineAreas"]) => void;
    onValidationChange?: (isValid: boolean, errors: Record<string, string>) => void;
}

const AboveWaterlineAreasForm: React.FC<Props> = ({ data, onChange, onValidationChange }) => {
    ...
    const handleChange = (field: keyof FormData['aboveWaterlineAreas'], value: string | number | string[]) => {
...
export default AboveWaterlineAreasForm;