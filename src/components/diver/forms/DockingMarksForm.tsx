...
interface Props {
    ...
    onChange: (data: FormData["dockingMarks"]) => void;
    onValidationChange?: (isValid: boolean, errors: Record<string, string>) => void;
}

const DockingMarksForm: React.FC<Props> = ({ data, onChange, onValidationChange }) => {
    ...
    const handleChange = (field: keyof FormData['dockingMarks'], value: string | number | string[]) => {
...
export default DockingMarksForm;